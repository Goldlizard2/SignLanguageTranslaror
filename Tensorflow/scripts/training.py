...
labels = [{'name':'Hello', 'id':1}, {'name':'No', 'id':2}, {'name':'Yes', 'id':3}, {'name':'ThankYou', 'id':4}, {'name':'ILoveYou', 'id':5}]
...
# generate TFRecords for train and test datasets
...
# Run the train and test commands
...
#Generate cmd command to train model
